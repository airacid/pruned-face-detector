...
from lib.core.model.net.vgg.pruned_backbone import vgg_ssd
...
class DSFD():
    ...
    def forward(self,inputs,boxes,labels,l2_regulation,training_flag,with_loss=True):
        ...
        origin_fms,enhanced_fms, endpoint=self.ssd_backbone(inputs,l2_regulation,training_flag)
        ...
        return reg_loss,cls_loss, endpoint
