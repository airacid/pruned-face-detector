...
config.MODEL.trained_model='./face_detector_pruned/optimized/epoch_5val_loss_3.ckpt'

#---------------------------------------------------------------------------------------------#
#---------------------------------------------------------------------------------------------#


config.MODEL.model_path = './face_detector/'                     # save directory

config.TRAIN.lr_value_every_step = [0.0005,0.0001,0.00005, 0.00001]     # learning rate value
config.TRAIN.lr_decay_every_step = [1000,5000,10000]             # learning rate decay step
